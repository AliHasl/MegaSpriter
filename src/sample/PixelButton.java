...
public class PixelButton extends Button {
    ...
    public PixelButton() {
        ...
        //this.addEventHandler(MouseEvent.MOUSE_ENTERED_TARGET, event -> this.setBackground(new Background(new BackgroundFill(Color.BLUEVIOLET, CornerRadii.EMPTY, Insets.EMPTY))));
    }
}
/*
    @Override
